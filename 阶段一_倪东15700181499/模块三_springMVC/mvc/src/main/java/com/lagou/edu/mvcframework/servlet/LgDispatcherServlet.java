...
import com.lagou.edu.mvcframework.zuoye.*;
...
public class LgDispatcherServlet extends HttpServlet {
    ...
    private void initHandlerMapping() {
        ...
        for(Map.Entry<String,Object> entry: ioc.entrySet()) {
            ...
            if(!aClass.isAnnotationPresent((Class<? extends Annotation>) TestController.class)) {continue;}


            String baseUrl = "";
            if(aClass.isAnnotationPresent(TestRequestMapping.class)) {
                TestRequestMapping annotation = aClass.getAnnotation(TestRequestMapping.class);
            ...
            for (int i = 0; i < methods.length; i++) {
                ...
                if(!method.isAnnotationPresent(TestRequestMapping.class)) {continue;}

                // 如果标识，就处理
                TestRequestMapping annotation = method.getAnnotation(TestRequestMapping.class);
    ...
    private void doAutoWired() {
        ...
        for(Map.Entry<String,Object> entry: ioc.entrySet()) {
            ...
            for (int i = 0; i < declaredFields.length; i++) {
                ...
                if(!declaredField.isAnnotationPresent(TestAutowired.class)) {
                    continue;
                }
    ...
    private void doInstance()  {
        ...
        try{
            ...
            for (int i = 0; i < classNames.size(); i++) {
                ...
                if(aClass.isAnnotationPresent((Class<? extends Annotation>) TestController.class)) {
...
//        method.invoke() //
        ...
        // 最终调用handler的method属性老师写的代码注释掉，手动新增下代码
        Object result = null;
